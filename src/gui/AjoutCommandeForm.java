 ...
 Form current; 
    Toolbar tb = new Toolbar(true);
     ...
     setToolbar(tb);
        ...
        //
        TextField refcommande = new TextField("","entrer la reference");
    refcommande.setUIID("TextFieldBlack");
     addStringValue("refcommande",refcommande);
     
    TextField etat = new TextField("","entrer l'etat");
    ...
    btnAjouter.addActionListener((e) -> {
        try{
            if (etat.getText().equals("") || refcommande.getText().equals("")){
                Dialog.show("verifier","","Annuler","OK");
            }
            else{
                InfiniteProgress ip = new InfiniteProgress();;
                final Dialog iDialog=ip.showInfiniteBlocking();
                SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
                Commande c = new Commande( refcommande.getText(),format.format(new Date()), etat.getText()
                       );
                System.out.println("date =="+c);
                ServiceCommande.getInstance().ajouter(c);
                iDialog.dispose();
                refreshTheme();
            }
